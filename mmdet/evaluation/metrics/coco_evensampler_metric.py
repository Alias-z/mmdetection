...
class CocoEevenSamplerMetric(BaseMetric):
    ...
    def results2json(self, results: Sequence[dict], outfile_prefix: str) -> dict:
        ...
        # print(f"Number of categories: {len(self.cat_ids)}")
        # print(f"Categories: {self.cat_ids}")
        ...
        for idx, result in enumerate(results):
            ...
            for i, label in enumerate(labels):
                ...
                # Directly use the label as the category_id
